...
function desenharProdutoNoCarrinho(idProduto) {
  ...
  const cartaoProdutoCarrinho = `
        ...
        <div class="flex text-slate-950 items-end absolute bottom-0 right-2 text-lg">
            ...
            <p id="quantidade-${quantidade.id}" class="ml-2">${idsProdutoCarrinhoComQuantidade.id}</p>
  ...
  elementoArticle.innerHTML = cartaoProdutoCarrinho;
    ...
    document.getElementById(`incrementar-produto-${produto.id}`).addEventListener("click", () => imcrementarQuantidadeProduto(produto.id));
